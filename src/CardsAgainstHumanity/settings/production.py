...
#    DJANGO_SETTINGS_MODULE=CardsAgainstHumanity.settings.production
...
# ALLOWED_HOSTS = ["CardsAgainstHumanity.com"]
...
STATIC_ROOT = os.path.join(BASE_DIR.parent, 'site', 'static')
